...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "sklr.utils._argsort",
        "sources": [
            "sklr/utils/_argsort.pyx"
        ]
    },
    "module_name": "sklr.utils._argsort"
}
END: Cython Metadata */
...
#define __PYX_HAVE__sklr__utils___argsort
#define __PYX_HAVE_API__sklr__utils___argsort
/* Early includes */
#include <float.h>
#include <stdint.h>
#include <string.h>
...
static int __pyx_f_4sklr_5utils_8_argsort__compare(const void *, const void *); /*proto*/
...
#define __Pyx_MODULE_NAME "sklr.utils._argsort"
extern int __pyx_module_is_main_sklr__utils___argsort;
int __pyx_module_is_main_sklr__utils___argsort = 0;

/* Implementation of 'sklr.utils._argsort' */
...
static int __pyx_f_4sklr_5utils_8_argsort__compare(const void *__pyx_v_a, const void *__pyx_v_b) {
  __pyx_t_4sklr_6_types_DTYPE_t __pyx_v_comparison;
  __pyx_t_4sklr_6_types_SIZE_t __pyx_v_a_index;
  __pyx_t_4sklr_6_types_SIZE_t __pyx_v_b_index;
  __pyx_t_4sklr_6_types_DTYPE_t __pyx_v_a_value;
  __pyx_t_4sklr_6_types_DTYPE_t __pyx_v_b_value;
  __pyx_t_4sklr_6_types_BOOL_t __pyx_v_is_nan_a;
  __pyx_t_4sklr_6_types_BOOL_t __pyx_v_is_nan_b;
  int __pyx_r;
  __pyx_t_4sklr_6_types_SIZE_t __pyx_t_1;
  __pyx_t_4sklr_6_types_DTYPE_t __pyx_t_2;
  int __pyx_t_3;
  int __pyx_t_4;
  int __pyx_t_5;

  /* "sklr/utils/_argsort.pyx":24
 *     cdef DTYPE_t comparison
 * 
 ...
 */
  __pyx_t_1 = ((struct __pyx_t_4sklr_5utils_8_argsort_Indexed *)__pyx_v_a)->index;
  __pyx_v_a_index = __pyx_t_1;

  /* "sklr/utils/_argsort.pyx":25
 * 
 *     cdef SIZE_t a_index = (<Indexed*> a).index
 *     cdef SIZE_t b_index = (<Indexed*> b).index             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t a_value = (<Indexed*> a).value
 ...
 */
  __pyx_t_1 = ((struct __pyx_t_4sklr_5utils_8_argsort_Indexed *)__pyx_v_b)->index;
  __pyx_v_b_index = __pyx_t_1;

  /* "sklr/utils/_argsort.pyx":26
 *     cdef SIZE_t a_index = (<Indexed*> a).index
 *     cdef SIZE_t b_index = (<Indexed*> b).index
 *     cdef DTYPE_t a_value = (<Indexed*> a).value             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t b_value = (<Indexed*> b).value
 * 
 */
  __pyx_t_2 = ((struct __pyx_t_4sklr_5utils_8_argsort_Indexed *)__pyx_v_a)->value;
  __pyx_v_a_value = __pyx_t_2;

  /* "sklr/utils/_argsort.pyx":27
 *     cdef SIZE_t b_index = (<Indexed*> b).index
 *     cdef DTYPE_t a_value = (<Indexed*> a).value
 *     cdef DTYPE_t b_value = (<Indexed*> b).value             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = ((struct __pyx_t_4sklr_5utils_8_argsort_Indexed *)__pyx_v_b)->value;
  __pyx_v_b_value = __pyx_t_2;

  /* "sklr/utils/_argsort.pyx":29
 *     cdef DTYPE_t b_value = (<Indexed*> b).value
 * 
 *     cdef BOOL_t is_nan_a = isnan(a_value)             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_v_is_nan_a = isnan(__pyx_v_a_value);

  /* "sklr/utils/_argsort.pyx":30
 * 
 *     cdef BOOL_t is_nan_a = isnan(a_value)
 *     cdef BOOL_t is_nan_b = isnan(b_value)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_is_nan_b = isnan(__pyx_v_b_value);

  /* "sklr/utils/_argsort.pyx":36
 ...
 */
  __pyx_t_4 = (__pyx_v_is_nan_a != 0);
  if (__pyx_t_4) {
  } else {
    __pyx_t_3 = __pyx_t_4;
    goto __pyx_L4_bool_binop_done;
  }
  __pyx_t_4 = (__pyx_v_is_nan_b != 0);
  __pyx_t_3 = __pyx_t_4;
  __pyx_L4_bool_binop_done:;
  if (__pyx_t_3) {

    /* "sklr/utils/_argsort.pyx":37
 *     # (and, therefore, randomness is mantained)
 *     if is_nan_a and is_nan_b:
 *         comparison = a_index - b_index             # <<<<<<<<<<<<<<
 *     elif is_nan_a and not is_nan_b:
 *         comparison = 1
 */
    __pyx_v_comparison = (__pyx_v_a_index - __pyx_v_b_index);
 ...
 */
  ...
  __pyx_t_4 = ((!(__pyx_v_is_nan_b != 0)) != 0);
  __pyx_t_3 = __pyx_t_4;
  __pyx_L6_bool_binop_done:;
  if (__pyx_t_3) {

    /* "sklr/utils/_argsort.pyx":39
 *         comparison = a_index - b_index
 *     elif is_nan_a and not is_nan_b:
 *         comparison = 1             # <<<<<<<<<<<<<<
 *     elif not is_nan_a and is_nan_b:
 ...
 */
  __pyx_t_4 = ((!(__pyx_v_is_nan_a != 0)) != 0);
  if (__pyx_t_4) {
  } else {
    __pyx_t_3 = __pyx_t_4;
 ...
 */
  /*else*/ {
    __pyx_t_3 = ((__pyx_v_a_value == __pyx_v_b_value) != 0);
    if (__pyx_t_3) {

      /* "sklr/utils/_argsort.pyx":46
 *     else:
 *         if a_value == b_value:
 *             comparison = a_index - b_index             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    /*else*/ {
      __pyx_v_comparison = (__pyx_v_a_value - __pyx_v_b_value);
    }
    __pyx_L10:;
  }
  __pyx_L3:;

  /* "sklr/utils/_argsort.pyx":50
 *             comparison = a_value - b_value
 * 
 *     return -1 if comparison <= 0 else 1             # <<<<<<<<<<<<<<
 * 
...
static __pyx_t_4sklr_6_types_SIZE_t *__pyx_f_4sklr_5utils_8_argsort_argsort(__pyx_t_4sklr_6_types_DTYPE_t *__pyx_v_data, __pyx_t_4sklr_6_types_INT64_t __pyx_v_n_values) {
  struct __pyx_t_4sklr_5utils_8_argsort_Indexed *__pyx_v_indexed;
  __pyx_t_4sklr_6_types_SIZE_t *__pyx_v_order;
  __pyx_t_4sklr_6_types_SIZE_t __pyx_v_index;
  __pyx_t_4sklr_6_types_SIZE_t *__pyx_r;
  __pyx_t_4sklr_6_types_INT64_t __pyx_t_1;
  __pyx_t_4sklr_6_types_INT64_t __pyx_t_2;
  __pyx_t_4sklr_6_types_SIZE_t __pyx_t_3;
  __pyx_t_4sklr_6_types_SIZE_t __pyx_t_4;

  /* "sklr/utils/_argsort.pyx":55
 * cdef SIZE_t* argsort(DTYPE_t *data, INT64_t n_values) nogil:
 *     """Compute the indexes that would sort the array."""
 *     cdef Indexed *indexed = <Indexed*> calloc(n_values, sizeof(Indexed))             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_v_indexed = ((struct __pyx_t_4sklr_5utils_8_argsort_Indexed *)calloc(__pyx_v_n_values, (sizeof(struct __pyx_t_4sklr_5utils_8_argsort_Indexed))));

  /* "sklr/utils/_argsort.pyx":56
 *     """Compute the indexes that would sort the array."""
 *     cdef Indexed *indexed = <Indexed*> calloc(n_values, sizeof(Indexed))
 *     cdef SIZE_t *order = <SIZE_t*> calloc(n_values, sizeof(SIZE_t))             # <<<<<<<<<<<<<<
 * 
 *     cdef SIZE_t index
 */
  __pyx_v_order = ((__pyx_t_4sklr_6_types_SIZE_t *)calloc(__pyx_v_n_values, (sizeof(__pyx_t_4sklr_6_types_SIZE_t))));

  /* "sklr/utils/_argsort.pyx":63
 ...
 */
  __pyx_t_1 = __pyx_v_n_values;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_index = __pyx_t_3;

    /* "sklr/utils/_argsort.pyx":64
 *     # array to know the sorted indexes
 *     for index in range(n_values):
 *         indexed[index].index = index             # <<<<<<<<<<<<<<
 *         indexed[index].value = data[index]
 * 
 */
    (__pyx_v_indexed[__pyx_v_index]).index = __pyx_v_index;

    /* "sklr/utils/_argsort.pyx":65
 *     for index in range(n_values):
 *         indexed[index].index = index
 *         indexed[index].value = data[index]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    (__pyx_v_indexed[__pyx_v_index]).value = (__pyx_v_data[__pyx_v_index]);
  }

  /* "sklr/utils/_argsort.pyx":67
 *         indexed[index].value = data[index]
 * 
 *     qsort(indexed, n_values, sizeof(Indexed), _compare)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  qsort(__pyx_v_indexed, __pyx_v_n_values, (sizeof(struct __pyx_t_4sklr_5utils_8_argsort_Indexed)), __pyx_f_4sklr_5utils_8_argsort__compare);

  /* "sklr/utils/_argsort.pyx":71
 *     # Copy the already sorted indexes from the
 ...
 *     free(indexed)
 */
    __pyx_t_4 = (__pyx_v_indexed[__pyx_v_index]).index;
    (__pyx_v_order[__pyx_v_index]) = __pyx_t_4;
  }

  /* "sklr/utils/_argsort.pyx":74
 *         order[index] = indexed[index].index
 * 
 *     free(indexed)             # <<<<<<<<<<<<<<
 * 
 *     return order
 */
  free(__pyx_v_indexed);

  /* "sklr/utils/_argsort.pyx":76
 *     free(indexed)
 * 
 *     return order             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "sklr.utils._argsort.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "sklr.utils._argsort.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "sklr.utils._argsort.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "sklr.utils._argsort._memoryviewslice", /*tp_name*/
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("argsort", (void (*)(void))__pyx_f_4sklr_5utils_8_argsort_argsort, "__pyx_t_4sklr_6_types_SIZE_t *(__pyx_t_4sklr_6_types_DTYPE_t *, __pyx_t_4sklr_6_types_INT64_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_argsort", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_sklr__utils___argsort) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "sklr.utils._argsort")) {
      if (unlikely(PyDict_SetItemString(modules, "sklr.utils._argsort", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init sklr.utils._argsort", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init sklr.utils._argsort");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT

...
def create_extension(extension_path):
    ...
    if extension_name == "sklr._highs_solver":
        language = "c"
        include_dirs.append("/home/Author/Software/micromamba/envs/Author-/include/highs")
        include_dirs.append("/home/Author/Software/micromamba/envs/Author-/include/highs/interfaces")
        library_dirs.append("/home/Author/Software/micromamba/envs/Author-/lib")
